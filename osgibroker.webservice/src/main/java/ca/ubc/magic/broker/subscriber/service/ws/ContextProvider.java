 ...
 * is a work around to solve the problem of passing objects to the web service that we have for OSGiBroker.
 * The current implementation is week and only provides a minimum basic ContextProvider with the 
 * RemotePublisherIF, SubscriberIF, and DBManagerIF to be passed to the web service. If the class doesn't invoke
...
public class ContextProvider {
	...
	private RemotePublisherIF  publisher  = null;
	...
	private ContextProvider(){
			...
			public EventStoreIF getEventStore() {
				return new EventStoreIF(){
					...
					public List<Event> getAfterEClient(String topic,
							String queryStart, String queryAfterE)
					...
					public List<Event> getAfterTClient(String topic,
							String queryStart, String queryAfterT)
							throws SQLException, XPathExpressionException {
						// TODO Auto-generated method stub
						return null;
					}
					...
					public List<Event> getBeforeEClient(String topic,
							String queryStart, String queryBeforeE)
							throws SQLException, XPathExpressionException {
						// TODO Auto-generated method stub
						return null;
					}
					...
					public List<Event> getBeforeTClient(String topic,
							String queryStart, String queryBeforeT)
							throws SQLException, XPathExpressionException {
						// TODO Auto-generated method stub
						return null;
					}
					...
					public List<Event> getFrameServerTime(String topic,
							String queryStartT, String queryEndT)
							throws XPathExpressionException, SQLException {
						// TODO Auto-generated method stub
						return null;
					}
		...
		this.subscriber = new WSSubscriberImpl(this.publisher, this.dbManager);
	}
	 ...
	 * 
	 * @param _publisher	The publisher to be used by the web service using the ContextProvider
	 * @param _dbManager	The dbManager to be used by the web service using the ContextProvider
	 * @param _subscriber	The subscriber to be used by the web service using the ContextProvider
	 */
	public void init(RemotePublisherIF _publisher, DBManagerIF _dbManager, 
	...
	public PublisherIF getPublisher(){
		return (PublisherIF) this.publisher;
	}
